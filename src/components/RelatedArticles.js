...
export const articleCollections = {
  walletSetup: [
    ...
    { title: "Before You Deposit", href: "/docs/learn/fundamentals/before-you-deposit/", tag: "Checklist" },
  ],
  keys: [
...
export default function RelatedArticles({ articles = [], collection, title = "Related Articles", columns = 2 }) {
