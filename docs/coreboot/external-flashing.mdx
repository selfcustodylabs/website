...
- Prepare your Raspberry Pi Pico with Serprog as [explained](/docs/libreboot/build-serprog) in the Libreboot guide
- Based on your BIOS Chip type (`SOIC` or `WSON`) Connect the Raspberry Pico to your Pomona Clip (1st photo) or Pogo Pin Adapter (2nd photo) using Dupont cables, as [explained](/docs/libreboot/pico-pomona-connection) in Libreboot guide.
...
Finally, [verify](/docs/coreboot/internal/flashing#verify-the-flashed-image) the flashed bios region.
