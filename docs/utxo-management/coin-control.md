...
- **Mixed UTXOs** — Post-[CoinJoin](/docs/coinjoin)
...
**Next:** Learn about [UTXO consolidation strategies](/docs/utxo-management/consolidation) to optimize your wallet during low-fee periods.
