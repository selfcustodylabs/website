...
2. Use [coin control](/docs/utxo-management/coin-control) to select only same-source UTXOs
...
- **You're mixing soon** — Let [CoinJoin](/docs/coinjoin) handle it
...
**Related:** Learn about [coin control](/docs/utxo-management/coin-control) to properly select UTXOs for consolidation.
