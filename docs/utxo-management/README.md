...
- Which have been through [CoinJoin](/docs/coinjoin)
...
UTXO management is foundational to Bitcoin privacy. Even if you use [CoinJoin](/docs/coinjoin), poor UTXO handling afterward destroys your gains.
...
For detailed post-CoinJoin practices, see our [CoinJoin Best Practices](/docs/coinjoin/best-practices) guide.
...
- [CoinJoin Privacy Guide](/docs/coinjoin) — Enhance privacy through mixing
- [CoinJoin Best Practices](/docs/coinjoin/best-practices) — Maintain privacy after mixing
- [Understanding Transactions](/docs/basics/transactions/understanding) — How Bitcoin transactions work
