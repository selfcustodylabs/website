...
<Grid container spacing={2}>
  <Grid item xs={12} sm={6} md={6} className="mdx-grid-item-center">
    <img src="/img/libreboot/floating-setup.webp" alt="Connection Setup" className="mdx-grid-image" />
  </Grid>
  
  <Grid item xs={12} sm={6} md={6} className="mdx-grid-item-center">
    <img src="/img/libreboot/floating-clip.webp" alt="Connection Clip" className="mdx-grid-image" />
  </Grid>
</Grid>
