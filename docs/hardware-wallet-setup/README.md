...
tags: ["hardware wallet", "self custody", "bitcoin", "security"]
---
...
You can import a seed phrase you created yourself (see our [DIY Seed Guide](/docs/seed)). This is more advanced but provides maximum trust minimization.
...
**This is not enough!** See our [Backup Verification Guide](/docs/backup-verification) for proper testing.
...
Many people lose Bitcoin because their backup was wrong. Always verify your backup works before depositing significant funds. See our [Backup Verification Guide](/docs/backup-verification).
...
Only use a passphrase if you fully understand the risks. See [DIY Passphrase Guide](/docs/passphrase) for details.
:::
...
1. **[Verify Your Backup](/docs/backup-verification)** — Test that your seed backup actually works
...
4. **[Learn UTXO Management](/docs/utxo-management)** — Manage your coins effectively
5. **Consider [Multisig](/docs/multisig)** — For significant holdings

---

## Related Guides

- [Backup Verification](/docs/backup-verification) — Test your backup before trusting it
- [DIY Seed Generation](/docs/seed) — Generate your own seed with dice
- [DIY Passphrase](/docs/passphrase) — Add a passphrase for extra security
- [Bitcoin Node Setup](/docs/bitcoin-node) — Run your own node for privacy
- [Hardware Wallets (Theory)](/docs/basics/wallets/hardware-wallets) — Understand how they work
