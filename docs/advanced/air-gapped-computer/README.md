---
sidebar_position: 3
title: "Air-Gapped Computer for Bitcoin: Maximum Security Setup"
...
tags: ["air-gapped", "computer", "seed", "wallet", "advanced"]
slug: /advanced/air-gapped-computer
---
...
- [What air-gapped wallets are](/docs/learn/wallets/air-gapped-wallets) and why they provide superior security
- [Private keys](/docs/learn/keys/intro) and why they must be protected
- [Seed phrases](/docs/learn/keys/seed) and how they work
:::
...
| Step | What You'll Do |
|------|----------------|
| 1. [Types of AGC](/docs/advanced/air-gapped-computer/types) | Choose your hardware approach |
| 2. [Setup](/docs/advanced/air-gapped-computer/setup) | Configure your air-gapped system |
