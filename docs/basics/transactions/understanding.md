...
:::tip Deep Dive
For a complete explanation of UTXOs, see [UTXOs Explained](/docs/basics/transactions/utxos).
:::
...
:::info Fee Insight
Fees depend on transaction **size** (in bytes), not the **value** being sent. More UTXOs means a larger transaction and higher fees. See [UTXOs Explained](/docs/basics/transactions/utxos) for details.
:::
