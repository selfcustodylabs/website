...
tags: ["bitcoin", "addresses", "segwit", "taproot", "basics"]
---
...
- [Private Keys Explained](/docs/basics/keys/intro) — How addresses are derived
- [Transactions Explained](/docs/basics/transactions/understanding) — How Bitcoin moves
- [UTXO Management](/docs/utxo-management) — Managing your coins effectively
