...
→ **Next:** [Connect Sparrow Wallet](https://selfcustodylabs.com/docs/bitcoin-node/connect-sparrow-wallet) (link your wallet)

→ **Back:** [Electrum Server](https://selfcustodylabs.com/docs/bitcoin-node/electrum-server) (understanding the indexer)

→ **Start:** [Parmanode Setup](https://selfcustodylabs.com/docs/bitcoin-node/parmanode-setup) (full installation guide)
