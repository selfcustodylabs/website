...
→ **Next:** [Tor Configuration](https://selfcustodylabs.com/docs/bitcoin-node/tor) (add network privacy)

→ **Connect:** [Connect Sparrow Wallet](https://selfcustodylabs.com/docs/bitcoin-node/connect-sparrow-wallet) (manual wallet connection)

→ **Back:** [Parmanode Setup](https://selfcustodylabs.com/docs/bitcoin-node/parmanode-setup) (installation guide)
