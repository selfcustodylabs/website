...
→ Read more: [Why Run Your Own Node](https://selfcustodylabs.com/docs/learn/nodes/why-run-node)
...
→ **[Start with Parmanode](https://selfcustodylabs.com/docs/bitcoin-node/parmanode-setup)**
...
→ **[Node Software Options](https://selfcustodylabs.com/docs/bitcoin-node/node-software-options)**: Compare your choices

→ **[Parmanode Setup Guide](https://selfcustodylabs.com/docs/bitcoin-node/parmanode-setup)**: Jump straight in (recommended)
