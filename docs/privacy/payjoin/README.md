---
sidebar_position: 4
title: "Bitcoin PayJoin: Privacy-Preserving Payments Explained"
...
Use [CoinJoin](/docs/privacy/coinjoin) when you need:
...
- **[CoinJoin Guide](/docs/privacy/coinjoin)** — For breaking transaction history
- **[UTXO Management](/docs/privacy/utxo-management)** — Control which coins you spend
