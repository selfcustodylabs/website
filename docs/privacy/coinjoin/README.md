---
sidebar_position: 3
title: "Bitcoin CoinJoin: How to Mix Your Bitcoin for Privacy"
...
**Prerequisites:** Understanding of [private keys](/docs/learn/keys/intro), [transactions](/docs/learn/transactions/understanding), [why privacy matters](/docs/learn/privacy/why-privacy-matters), and ideally running your own [Bitcoin node](/docs/bitcoin-node)
:::

:::tip Background Reading
If you haven't already, read [Why Bitcoin Privacy Matters](/docs/learn/privacy/why-privacy-matters) and [Chain Analysis Explained](/docs/learn/privacy/chain-analysis) to understand the surveillance problem CoinJoin solves.
:::
...
CoinJoin operates on UTXOs (Unspent Transaction Outputs). If you're not familiar with how UTXOs work, read [UTXOs Explained](/docs/learn/transactions/utxos) first—it's essential background for understanding CoinJoin.
...
2. **Learn more:** Understand [transactions](/docs/learn/transactions/understanding) deeply
3. **Choose a method:** 
...
- [UTXO Management](/docs/privacy/utxo-management) — Essential foundation for understanding CoinJoin
- [Bitcoin Node Setup](/docs/bitcoin-node) — Essential for private CoinJoin use
- [Understanding Transactions](/docs/learn/transactions/understanding) — Know how Bitcoin transactions work
- [Air-Gapped Computer](/docs/advanced/air-gapped-computer) — Maximum security for signing
