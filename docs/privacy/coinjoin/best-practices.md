...
**Related Guides:**
- [UTXO Management](/docs/privacy/utxo-management) — Master coin control and consolidation
- [Coin Control Guide](/docs/privacy/utxo-management/coin-control) — Detailed coin control techniques
- [Bitcoin Node Setup](/docs/bitcoin-node) — Run your own node
- [Understanding Transactions](/docs/learn/transactions/understanding) — Know how transactions work
