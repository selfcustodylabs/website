...
→ **[Multisig](https://selfcustodylabs.com/docs/learn/wallets/multisig/)** is your answer. Start with 2-of-3.

### "I want my family to inherit my Bitcoin"
→ **[Inheritance Planning](https://selfcustodylabs.com/docs/advanced/inheritance-planning)**: don't let your Bitcoin die with you.

### "I want to generate my own seed securely"
→ **[Air-gapped computer](https://selfcustodylabs.com/docs/learn/wallets/air-gapped-wallets/)** + [DIY seed guide](https://selfcustodylabs.com/docs/learn/keys/random/)

### "I want a clean environment for Bitcoin"
→ **[Dedicated Bitcoin computer](https://selfcustodylabs.com/docs/advanced/bitcoin-computer/)**

### "I want maximum possible security"
→ All of the above, plus **[open firmware](https://selfcustodylabs.com/docs/libreboot/)**
