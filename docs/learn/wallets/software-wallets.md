...
→ **Next:** [Hardware Wallets](https://selfcustodylabs.com/docs/learn/wallets/hardware-wallets) (for serious savings)

→ **Setup Guide:** [Hardware Wallet Setup](https://selfcustodylabs.com/docs/wallet-setup/hardware-wallet) (get started with hardware)

→ **Privacy:** [Why Privacy Matters](https://selfcustodylabs.com/docs/learn/privacy/why-privacy-matters) (understand the risks)
