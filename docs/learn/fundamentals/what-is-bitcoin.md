...
Actually, Bitcoin is **pseudonymous**. Transactions are public and can be traced. Privacy requires deliberate effort. See our [privacy section](/docs/learn/privacy/why-privacy-matters).
...
1. **Buy from an exchange** — Platforms where you can purchase bitcoin with traditional currency
2. **Receive as payment** — Accept bitcoin for goods or services
3. **Peer-to-peer** — Buy directly from another person
4. **Earn it** — Work for employers who pay in bitcoin
5. **Mine it** — Run mining hardware (requires significant investment)
