...
![Anatomy of the derivation path m/44'/0'/0'/0/0: master seed, purpose, coin type where 0 means Bitcoin, account number, change flag where 0 is external and 1 is change, and the address index](/img/diagrams/keys/derivation-path-anatomy.svg)
