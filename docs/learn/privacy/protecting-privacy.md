...
Now that you understand [why privacy matters](/docs/learn/privacy/why-privacy-matters) and [how chain analysis works](/docs/learn/privacy/chain-analysis), let's look at what you can do about it.
...
→ **Learn:** [What is a Bitcoin Node](/docs/learn/nodes/what-is-node) | [Why Run Your Own](/docs/learn/nodes/why-run-node)
