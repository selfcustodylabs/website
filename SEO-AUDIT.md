...
- [ ] Search all `.md`, `.mdx`, and page components for any `noindex` meta tags, checking for `<meta name="robots" content="noindex">` or Docusaurus front matter like `unlisted: true`, `draft: true`, or `sidebar_class_name` hacks that hide pages
